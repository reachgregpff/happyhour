...
<div id="container">
  <h2>No route matches [GET] &quot;/bootstrap/js/bootstrap.js&quot;</h2>

  
<p><code>Rails.root: /Users/greg/wdi/PROJECTS/group_project/happyhour</code></p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/info(.:format)' data-regexp='^\/info(?:\.([^\/.?]+))?$'>
    /info(.:format)
  </td>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='session#new'>
    session#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='session#create'>
    session#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='session#destroy'>
    session#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='cocktails'>
      cocktails<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/cocktails(.:format)' data-regexp='^\/cocktails(?:\.([^\/.?]+))?$'>
    /cocktails(.:format)
  </td>
  <td data-route-reqs='cocktails#list'>
    cocktails#list
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='like_cocktail'>
      like_cocktail<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/like_cocktail(.:format)' data-regexp='^\/like_cocktail(?:\.([^\/.?]+))?$'>
    /like_cocktail(.:format)
  </td>
  <td data-route-reqs='pages#like_cocktail'>
    pages#like_cocktail
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/cocktails/:cocktail_id(.:format)' data-regexp='^\/cocktails\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /cocktails/:cocktail_id(.:format)
  </td>
  <td data-route-reqs='cocktails#show'>
    cocktails#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='bars'>
      bars<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bars(.:format)' data-regexp='^\/bars(?:\.([^\/.?]+))?$'>
    /bars(.:format)
  </td>
  <td data-route-reqs='bars#index'>
    bars#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='bars#create'>
    bars#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_bar'>
      new_bar<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bars/new(.:format)' data-regexp='^\/bars\/new(?:\.([^\/.?]+))?$'>
    /bars/new(.:format)
  </td>
  <td data-route-reqs='bars#new'>
    bars#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_bar'>
      edit_bar<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bars/:id/edit(.:format)' data-regexp='^\/bars\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /bars/:id/edit(.:format)
  </td>
  <td data-route-reqs='bars#edit'>
    bars#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='bar'>
      bar<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/bars/:id(.:format)' data-regexp='^\/bars\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /bars/:id(.:format)
  </td>
  <td data-route-reqs='bars#show'>
    bars#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='bars#update'>
    bars#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='bars#destroy'>
    bars#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='api_bars'>
      api_bars<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/api/bars(.:format)' data-regexp='^\/api\/bars(?:\.([^\/.?]+))?$'>
    /api/bars(.:format)
  </td>
  <td data-route-reqs='api/bars#index'>
    api/bars#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='api/bars#create'>
    api/bars#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='api_bar'>
      api_bar<span class='helper'>_path</span>
  </td>
  <td data-route-verb='DELETE'>
    DELETE
  </td>
  <td data-route-path='/api/bars/:id(.:format)' data-regexp='^\/api\/bars\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /api/bars/:id(.:format)
  </td>
  <td data-route-reqs='api/bars#destroy'>
    api/bars#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='api_barfaves'>
      api_barfaves<span class='helper'>_path</span>
  </td>
  <td data-route-verb='POST'>
    POST
  </td>
  <td data-route-path='/api/barfaves(.:format)' data-regexp='^\/api\/barfaves(?:\.([^\/.?]+))?$'>
    /api/barfaves(.:format)
  </td>
  <td data-route-reqs='api/barfaves#create'>
    api/barfaves#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/api/barfaves/:id(.:format)' data-regexp='^\/api\/barfaves\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /api/barfaves/:id(.:format)
  </td>
  <td data-route-reqs='api/barfaves#destroy'>
    api/barfaves#destroy
  </td>
</tr>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;RN+wcB1qmbHCqi1ZtfeubeYi4zdKX/eDa0ToFnfLS2w=&quot;
session_id: &quot;5d426f7993be05be0f36b4702603104e&quot;</pre></div>
</div>
...
<div id="console"
  data-remote-path='console/repl_sessions/c3e28e241867ea7d81ab7cf96230275a'
  data-initial-prompt='>> '>
</div>
